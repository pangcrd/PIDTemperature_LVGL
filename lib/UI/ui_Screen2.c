...
void ui_Screen2_screen_init(void)
{
    ...
    lv_obj_set_width(ui_Chart1, 281);
    ...
    lv_chart_set_range(ui_Chart1, LV_CHART_AXIS_PRIMARY_Y, 25, 100);
    ...
    lv_scale_set_range(ui_Chart1_Xaxis, 0, 20 > 0 ? 20 - 1 : 0);
    lv_scale_set_total_tick_count(ui_Chart1_Xaxis, (20 > 0 ? 20 - 1 : 0) * 1 + 1);
    ...
    lv_obj_set_style_length(ui_Chart1_Yaxis1, 6, LV_PART_ITEMS);   //minor tick length
    lv_obj_set_style_length(ui_Chart1_Yaxis1, 5, LV_PART_INDICATOR);   //major tick length
    lv_scale_set_range(ui_Chart1_Yaxis1,  25, 100);
    lv_scale_set_total_tick_count(ui_Chart1_Yaxis1, (10 > 0 ? 10 - 1 : 0) * 1 + 1);
    ...
    ui_Chart1_series_1 = lv_chart_add_series(ui_Chart1, lv_color_hex(0x00FF2F),
    ...
    lv_obj_set_y(ui_Label7, -97);
    lv_obj_set_align(ui_Label7, LV_ALIGN_CENTER);
    lv_label_set_text(ui_Label7, "TEMP:");
    lv_obj_set_style_text_color(ui_Label7, lv_color_hex(0xFF3EE9), LV_PART_MAIN | LV_STATE_DEFAULT);
    ...
    lv_label_set_text(ui_Label8, "30*C");
    lv_obj_set_style_text_color(ui_Label8, lv_color_hex(0xFF3EE9), LV_PART_MAIN | LV_STATE_DEFAULT);
